    ...
    <div class="row justify-content-center fade-in-up">
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-lg border-0">
                <div class="card-header text-center bg-gradient-secondary text-white py-4">
                    <h4 class="mb-0 fw-bold"><i class="fas fa-user-shield me-2"></i>Admin Login</h4>
                </div>
                <div class="card-body p-5">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-lg w-100 bg-gradient-secondary text-white">
